...
CREATE TABLE Customer (CustomerID int(10) NOT NULL AUTO_INCREMENT, AddressID int(10) NOT NULL, PersonID int(10) NOT NULL, ShoppingCartID int(10), newsletter tinyint, PRIMARY KEY (CustomerID)) ENGINE=InnoDB;
...
CREATE TABLE Content (PageID varchar(50) NOT NULL, Section varchar(50) NOT NULL, HTML LONGTEXT NULL, Upd_dt datetime NOT NULL);
CREATE TABLE Content_category (    ContentCategoryID int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT, PageID varchar(50) NOT NULL, Section varchar(50) NOT NULL, CategoryID int(11) NOT NULL, SeqNum int (4) NOT NULL);
