...
CREATE TABLE Deliverymethod (DeliveryMethodID int(10) NOT NULL AUTO_INCREMENT, `DeliveryMethodNa

me` varchar(50), LastEditedBy int(11) NOT NULL, PRIMARY KEY (DeliveryMethodID)) ENGINE=InnoDB;
...
CREATE TABLE `Order` (OrderID int(11) NOT NULL AUTO_INCREMENT, CustomerID int(10) NOT NULL, OrderDae date, ExpectedDeliveryDate date, LastEditedBy int(11) NOT NULL, DeliveryMethodID int(10) NOT NULL, PaymentMethodID int(11) NOT NULL, SpecialDealID int(11), PRIMARY KEY (OrderID)) ENGINE=InnoDB;
